...
Locator: locator('[data-test="inventory-item"]').filter({ hasText: 'Sauce Labs Backpack' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-test="inventory-item"]').filter({ hasText: 'Sauce Labs Backpack' })
