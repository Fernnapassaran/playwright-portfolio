...
Locator: locator('data-test="inventory-item >> internal:has-text="Sauce Labs Backpack"i >> internal:chain="button:has-text(\\"Add to cart\\")"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('data-test="inventory-item >> internal:has-text="Sauce Labs Backpack"i >> internal:chain="button:has-text(\\"Add to cart\\")"')
